...
export default function Topic2_IntelligentBehavior() {
    return (
        <div className="max-w-4xl mx-auto pb-20 space-y-12">
            <TopicProgressTracker topicId="unit4-topic2_intelligentbehavior" />
            ...
            <SectionWrapper id="prerequisites" title="0. Prerequisites" subtitle="What you should know before starting" icon={<BookOpen className="text-sky-600" size={24} />} badge="Prerequisites" badgeColor="bg-sky-100 text-sky-700" accentColor="border-sky-500">
                <div className="space-y-3">
                    {(() => { const d = getTopicData('unit4', 'Topic2_IntelligentBehavior'); if (!d) return null; return (<ul className="list-disc list-inside space-y-2 text-sm text-slate-700 dark:text-slate-300">{d.prerequisites.map((p,i) => <li key={i}>{p}</li>)}</ul>); })()}
                </div>
            </SectionWrapper>
                    ...
                    <div className="mt-2 mb-6 p-5 bg-gradient-to-r from-indigo-50 to-purple-50 dark:from-indigo-900/20 dark:to-purple-900/20 rounded-2xl border border-indigo-100 dark:border-indigo-800 shadow-sm flex items-start gap-4 transform hover:scale-[1.02] transition-transform">
                        ...
                        <div>
                            ...
                            <p className="text-indigo-700 dark:text-indigo-300 font-medium italic leading-relaxed">
                                "Defining 'intelligence' is hard. For a thermostat, it's turning off at 72 degrees. For a human, it's not pressing 'Reply All'."
                            </p>
                        </div>
                    </div>
                ...
                <div className="space-y-6">
                    ...
                    <div className="bg-gradient-to-r from-amber-50 to-orange-50 dark:from-amber-950/20 dark:to-orange-950/20 p-6 rounded-3xl border border-amber-100 dark:border-amber-900 shadow-sm flex items-start gap-4 animate-fade-in">
                        ...
                        <div className="space-y-2">
                            ...
                            <p className="text-slate-700 dark:text-slate-300 text-sm leading-relaxed">
                                Formulating an exact, computational definition of what makes an action 'intelligent' in a dynamic, unpredictable world.
                            </p>
                        </div>
                    </div>
                    ...
                    <div className="bg-white dark:bg-slate-800/40 p-6 rounded-3xl border border-slate-100 dark:border-slate-800 shadow-sm">
                        ...
                        <p className="text-slate-600 dark:text-slate-400 text-sm leading-relaxed">
                            Crucial to prevent AI developers from writing brittle, rule-based logic that cracks under minor environmental changes.
                        </p>
                    </div>
                    ...
                    <div className="grid sm:grid-cols-2 gap-4">
                        <div className="bg-emerald-50/50 dark:bg-emerald-950/10 p-5 rounded-2xl border border-emerald-100 dark:border-emerald-900 shadow-sm flex gap-3 hover:scale-[1.01] transition-all">
                            ...
                            <div>
                                ...
                                <p className="text-slate-600 dark:text-slate-400 text-xs leading-relaxed">
                                    Introduces rigorous frameworks (like rationality and utility) to define and measure success in agent design.
                                </p>
                            </div>
                        </div>
                        ...
                        <div className="bg-rose-50/50 dark:bg-rose-950/10 p-5 rounded-2xl border border-rose-100 dark:border-rose-900 shadow-sm flex gap-3 hover:scale-[1.01] transition-all">
                            ...
                            <div>
                                ...
                                <p className="text-slate-600 dark:text-slate-400 text-xs leading-relaxed">
                                    Intelligence criteria can be highly abstract and hard to translate directly into low-level micro-controller code.
                                </p>
                            </div>
                        </div>
                    </div>
...
{/* SECTION 3: MATHEMATICAL MODELLING */}
            <SectionWrapper 
                id="math" 
                title="3. The Performance Measure" 
            ...
            {/* INTERACTIVE DIAGRAM */}
            <InteractiveDiagram 
                title="Intelligent Behavior Architecture"
                description="What constitutes intelligence in machines."
                chart={`graph TD
    ...
    IB --> Learn[Learning from Experience]`}
            ...
            <SectionWrapper 
                id="project" 
                title="5. Project: Defining an Intelligent Vacuum" 
            ...
            <SectionWrapper 
                id="lab" 
                title="7. Virtual Lab: Behavioral Radar" 
            ...
            >
                <div className="space-y-6">
                <VirtualLabShell
                    title="Turing Test Simulator"
                    description="Test machine intelligence criteria"
            ...
            <SectionWrapper id="mcq" title="8. Knowledge Check" subtitle="10 Feedback-Based MCQs" icon={<HelpCircle className="text-purple-600" size={24} />} badge="MCQ Quiz" badgeColor="bg-purple-100 text-purple-700" accentColor="border-purple-500">
                {(() => { const d = getTopicData('unit4', 'Topic2_IntelligentBehavior'); if (!d) return null; return <FeedbackMCQ questions={d.mcqs} />; })()}
            </SectionWrapper>
            ...
            <div className="bg-primary-600 rounded-[2.5rem] p-10 text-center text-white space-y-6 shadow-2xl shadow-primary-500/20">
                    ...
                    <div className="max-w-xl mx-auto mb-6">
                        ...
                        {(() => { const d = getTopicData('unit4', 'Topic2_IntelligentBehavior'); if (!d) return null; return (
