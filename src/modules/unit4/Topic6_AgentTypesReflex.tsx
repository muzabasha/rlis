...
import {
    ...
    Bot, Zap, Binary, Layers, Eye, ChevronRight,
    Play, RotateCcw, Search, Brain, Globe, Rocket,
    Activity, Settings, Cpu, HardDrive, Briefcase,
    Shield, Move, MousePointer2, User, Layout, Map, Target
} from 'lucide-react';
...
export default function Topic6_AgentTypesReflex() {
    return (
        <div className="max-w-4xl mx-auto pb-20 space-y-12">
            ...
            <SectionWrapper 
                id="math" 
                title="2. Modelling the Agent Function" 
            ...
            <SectionWrapper 
                id="activity" 
                title="3. Activity: Brain Selector" 
            ...
            <SectionWrapper 
                id="lab" 
                title="6. Virtual Lab: Logic Circuit" 
            ...
            <div className="bg-primary-600 rounded-[2.5rem] p-10 text-center text-white space-y-6 shadow-2xl shadow-primary-500/20">
                <div className="max-w-xl mx-auto space-y-2">
                    <h3 className="text-3xl font-black italic">Brains: Decoded!</h3>
                    <p className="text-primary-100">
                        You know how agents think. Now, let's explore the "Stages" they play on—the Environment Types.
                    </p>
                </div>
