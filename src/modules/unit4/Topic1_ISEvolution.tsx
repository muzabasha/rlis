...
const notebook: NotebookEntry[] = [
    {
        "task": "Perform 5 separate step cycles on the I S Evolution simulator.",
...
const logs: string[] = [
    "🤖 [System] Initializing I S Evolution Experiential Simulator...",
    "📡 [Telemetry] Connecting data streams... Connected.",
    "💡 [Pedagogy] Concept: \"I S Evolution\" model has been loaded and initialized. Ready for student interaction."
];
        ...
        <div className="max-w-4xl mx-auto pb-20 space-y-12">
            ...
            <SectionWrapper id="prerequisites" title="0. Prerequisites" subtitle="What you should know before starting" icon={<BookOpen className="text-sky-600" size={24} />} badge="Prerequisites" badgeColor="bg-sky-100 text-sky-700" accentColor="border-sky-500">
                <div className="space-y-3">
                    {(() => { const d = getTopicData('unit4', 'Topic1_ISEvolution'); if (!d) return null; return (<ul className="list-disc list-inside space-y-2 text-sm text-slate-700 dark:text-slate-300">{d.prerequisites.map((p,i) => <li key={i}>{p}</li>)}</ul>); })()}
                </div>
            </SectionWrapper>
                ...
                <div className="space-y-6">
                    ...
                    <div className="bg-gradient-to-r from-amber-50 to-orange-50 dark:from-amber-950/20 dark:to-orange-950/20 p-6 rounded-3xl border border-amber-100 dark:border-amber-900 shadow-sm flex items-start gap-4 animate-fade-in">
                        ...
                        <div className="space-y-2">
                            ...
                            <p className="text-slate-700 dark:text-slate-300 text-sm leading-relaxed">
                                Tracing how artificial decision engines evolved from simple mechanical relays to advanced neural net systems that learn directly from environment telemetry.
                            </p>
                        </div>
                    </div>
                    ...
                    <div className="bg-white dark:bg-slate-800/40 p-6 rounded-3xl border border-slate-100 dark:border-slate-800 shadow-sm">
                        ...
                        <p className="text-slate-600 dark:text-slate-400 text-sm leading-relaxed">
                            Essential for understanding the historical context and architectural breakthroughs that paved the way for modern deep learning and RL.
                        </p>
                    </div>
                    ...
                    <div className="grid sm:grid-cols-2 gap-4">
                        <div className="bg-emerald-50/50 dark:bg-emerald-950/10 p-5 rounded-2xl border border-emerald-100 dark:border-emerald-900 shadow-sm flex gap-3 hover:scale-[1.01] transition-all">
                            ...
                            <div>
                                ...
                                <p className="text-slate-600 dark:text-slate-400 text-xs leading-relaxed">
                                    Provides a comprehensive evolutionary map of artificial intelligence; sets expectations for future system capability.
                                </p>
                            </div>
                        </div>
                        ...
                        <div className="bg-rose-50/50 dark:bg-rose-950/10 p-5 rounded-2xl border border-rose-100 dark:border-rose-900 shadow-sm flex gap-3 hover:scale-[1.01] transition-all">
                            ...
                            <div>
                                ...
                                <p className="text-slate-600 dark:text-slate-400 text-xs leading-relaxed">
                                    Purely qualitative history that doesn't replace the need for hands-on, rigorous algorithm engineering.
                                </p>
                            </div>
                        </div>
                    </div>
...
{/* SECTION 3: MATHEMATICAL MODELLING */}
            <SectionWrapper 
                id="math" 
                title="3. Modelling Universal Intelligence" 
    ...
    RL --> AGI[Towards AGI]`}
            ...
            <SectionWrapper 
                id="project" 
                title="5. Project: From Expert to Learner" 
            ...
            <SectionWrapper 
                id="lab" 
                title="7. Virtual Lab: Evolution Visualizer" 
            ...
            <SectionWrapper id="mcq" title="8. Knowledge Check" subtitle="10 Feedback-Based MCQs" icon={<HelpCircle className="text-purple-600" size={24} />} badge="MCQ Quiz" badgeColor="bg-purple-100 text-purple-700" accentColor="border-purple-500">
                {(() => { const d = getTopicData('unit4', 'Topic1_ISEvolution'); if (!d) return null; return <FeedbackMCQ questions={d.mcqs} />; })()}
            </SectionWrapper>
            ...
            <div className="bg-primary-600 rounded-[2.5rem] p-10 text-center text-white space-y-6 shadow-2xl shadow-primary-500/20">
                    ...
                    <div className="max-w-xl mx-auto mb-6">
                        ...
                        {(() => { const d = getTopicData('unit4', 'Topic1_ISEvolution'); if (!d) return null; return (
