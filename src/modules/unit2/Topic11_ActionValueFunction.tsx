...
import {
    ...
    Zap, Target, LayoutGrid, Brain, Swords, Focus, CheckCircle2, XCircle,
    ArrowRight, TrendingUp, Briefcase, Binary, Info
} from 'lucide-react';
...
export default function Topic11_ActionValueFunction() {
    ...
    Cond --> Pi[Following policy &pi; thereafter]`}
            ...
            <SectionWrapper 
                id="project" 
                title="4. Project: Game Engine Ranking" 
            ...
            <SectionWrapper 
                id="lab" 
                title="6. Virtual Lab: Action-Value Explorer" 
