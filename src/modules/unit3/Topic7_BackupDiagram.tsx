...
import {
    ...
    Share2, GitBranch, Target, Briefcase, Zap, Binary, Layers,
...
export default function Topic7_BackupDiagram() {
    return (
        <div className="max-w-4xl mx-auto pb-20 space-y-12">
            ...
            <SectionWrapper 
                id="math" 
                title="2. Mapping Diagram to Equation" 
            ...
            <SectionWrapper 
                id="project" 
                title="4. Project: Paper Research" 
            ...
            <SectionWrapper 
                id="lab" 
                title="6. Virtual Lab: The Diagram Explorer" 
