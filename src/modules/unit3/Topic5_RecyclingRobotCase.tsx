...
import {
    ...
    Bot, Zap, Battery, Search, RefreshCcw, TrendingUp, Target, LayoutGrid,
    Brain, Swords, Focus, CheckCircle2, Play, Pause, RotateCcw,
    ChevronRight, Binary, Trophy, Briefcase, Layers, Eye
} from 'lucide-react';
...
export default function Topic5_RecyclingRobotCase() {
    return (
        <div className="max-w-4xl mx-auto pb-20 space-y-12">
            ...
            <SectionWrapper 
                id="math" 
                title="2. Modelling the Robot MDP" 
            ...
            <SectionWrapper 
                id="project" 
                title="4. Project: The Rescue Signal" 
            ...
            <SectionWrapper 
                id="lab" 
                title="6. Virtual Lab: Robot Command Center" 
