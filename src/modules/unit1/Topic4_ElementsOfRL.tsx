        ...
        <div className="max-w-4xl mx-auto pb-20 space-y-12">
            ...
            >
                <div className="space-y-8">
                    <div>
                        <h4 className="text-lg font-bold text-slate-800 dark:text-white mb-2">Why do we need math here?</h4>
                        <p className="text-sm text-slate-600 dark:text-slate-400">
                            Words like "hunch" and "recipe" are great for stories, but computers need numbers. We need to formalize how an agent weighs immediate vs. future rewards.
                        </p>
                    </div>
                    ...
                    <div className="grid lg:grid-cols-2 gap-8">
                        <div className="space-y-6">
                            <MathBlock 
                                formula="G_t = R_{t+1} + \gamma R_{t+2} + \gamma^2 R_{t+3} + \dots = \sum_{k=0}^{\infty} \gamma^k R_{t+k+1}"
                                label="The Total Return (Gₜ)"
                                explanation="This equation represents the sum of all future rewards, where future rewards are 'discounted' by gamma (γ)."
                            />
                            
                            <SymbolTable 
                                symbols={[
                                    { symbol: 'G_t', meaning: 'The total reward the agent expects from time t onwards.' },
                                    { symbol: 'R_{t+1}', meaning: 'Immediate reward received at the next step.' },
                                    { symbol: '\gamma', meaning: 'Discount factor (0 to 1). Determines importance of future rewards.' },
                                    { symbol: '\pi(a|s)', meaning: 'Policy - probability of taking action a in state s.' }
                                ]}
                            />
                        </div>
                    ...
                    <div className="p-6 bg-slate-900 rounded-3xl text-white space-y-4">
                        <h4 className="font-bold flex items-center gap-2"><Lightbulb className="text-amber-400" size={18} /> The Value Function Equation</h4>
                        <p className="text-sm text-slate-300">
                            The State-Value function $v_\pi(s)$ is the "Hunch". It calculates how good it is for the agent to be in a certain state $s$, following policy $\pi$.
                        </p>
                        <div className="bg-slate-800/50 p-4 rounded-xl text-center font-mono text-xl text-primary-400 overflow-x-auto">
